...
BEGIN_MESSAGE_MAP(CFormCommandView, CFormView)
	...
	//}}AFX_MSG_MAP
	ON_EN_CHANGE(IDC_EDIT2, &CFormCommandView::OnEnChangeEdit2)
	ON_EN_CHANGE(IDC_EDIT6, &CFormCommandView::OnEnChangeEdit6)
	ON_NOTIFY(NM_CUSTOMDRAW, IDC_SLIDER_Z, &CFormCommandView::OnNMCustomdrawSliderZ)
END_MESSAGE_MAP()
...
void CFormCommandView::OnEnChangeEdit1()
{
...
void CFormCommandView::OnCbnSelchangeCombo1()
{
	// TODO: 在此添加控件通知处理程序代码
}


void CFormCommandView::OnEnChangeEdit2()
{
	// TODO:  如果该控件是 RICHEDIT 控件，它将不
	// 发送此通知，除非重写 CFormView::OnInitDialog()
	// 函数并调用 CRichEditCtrl().SetEventMask()，
...
void CFormCommandView::OnEnChangeEdit6()
{
	// TODO:  如果该控件是 RICHEDIT 控件，它将不
	// 发送此通知，除非重写 CFormView::OnInitDialog()
	// 函数并调用 CRichEditCtrl().SetEventMask()，
...
void CFormCommandView::OnNMCustomdrawSliderZ(NMHDR* pNMHDR, LRESULT* pResult)
{
